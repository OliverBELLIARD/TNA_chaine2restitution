...
semilogx(frequencies_in, 20 * log10(input_fft(1:N_fft/2)), 'b', 'DisplayName', 'Signal Entrée FFT');
hold on;
semilogx(frequencies_out, 20 * log10(output_fft(1:N_fft/2)), 'r', 'DisplayName', 'Signal Final FFT');
hold off;
